...
from pyqtbook.chap06.helpform import *  # @UnusedWildImport
from pyqtbook.chap06.newimagedlg import *  # @UnusedWildImport
from pyqtbook.chap06.qrc_resources import *  # @UnusedWildImport
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        fileSaveAsAction = self.createAction("Save &As...",
                                             self.fileSaveAs,
                                             icon="filesaveas",
                                             tip="Save the image using a new name")  # @IgnorePep8
        ...
        editSwapRedAndBlueAction = self.createAction("Sw&ap Red and Blue",
                                                     ...
                                                     "Ctrl+A", "editswap",
                                                     "Swap the image's red and blue color components",  # @IgnorePep8
                                                     True,
                                                     "toggled(bool)")
