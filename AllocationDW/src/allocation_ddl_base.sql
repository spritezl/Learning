...
(
  ...
  CYEAR_SEQ  NUMBER(4) NOT NULL
);

CREATE TABLE DIM_DATE_CMONTH(
(
  CMONTH_ID         NUMBER(6) NOT NULL,
  CMONTH_DESC       VARCHAR2(10) NOT NULL,
  CYEAR_ID          NUMBER(4) NOT NULL,
  CMONTH_OF_CYEAR   NUMBER(2) NOT NULL,
  CMONTH_NAME       VARCHAR2(10) NOT NULL,
  IS_FIRST_OF_CYEAR CHAR(1) NOT NULL,
  IS_LAST_OF_CYEAR  CHAR(1) NOT NULL,
  START_DATE        DATE NOT NULL,
  END_DATE          DATE NOT NULL,
  TIME_SPAN         NUMBER(2) NOT NULL,
  CMONTH_NUM        NUMBER(6) NOT NULL,
  CMONTH_SEQ        NUMBER(6) NOT NULL
);

ALTER TABLE DIM_DATE_CMONTH ADD CONSTRAINT FKDIM_DATE_CMONTH_CY FOREIGN KEY(CYEAR_ID) REFERENCES DIM_DATE_CYEAR(CYEAR_ID);
CREATE INDEX XIE1DIM_DATE_MONTH ON DIM_DATE_MONTH(CYEAR_ID);



--7th year
CREATE TABLE DIM_DATE_SMYEAR(
SMYEAR_ID   NUMBER(4) NOT NULL,
SMYEAR_DESC VARCHAR2(10) NOT NULL,
START_DATE  DATE NOT NULL,
END_DATE    DATE NOT NULL,
TIME_SPAN   NUMBER(3) NOT NULL,
SMYEAR_NUM  NUMBER(4) NOT NULL,
SMYEAR_SEQ  NUMBER(4) NOT NULL
);
-- CREATE/RECREATE PRIMARY, UNIQUE AND FOREIGN KEY CONSTRAINTS 
ALTER TABLE DIM_DATE_SMYEAR
  ADD CONSTRAINT PKDIM_DATE_SMYEAR PRIMARY KEY (SMYEAR_ID);
...
(
  ...
  SMYEAR_ID          NUMBER(4) NOT NULL,
  SMONTH_OF_SMYEAR   NUMBER(2) NOT NULL,
  SMONTH_NAME        VARCHAR2(10) NOT NULL,
  IS_FIRST_OF_SMYEAR CHAR(1) NOT NULL,
  IS_LAST_OF_SMYEAR  CHAR(1) NOT NULL,
  START_DATE         DATE NOT NULL,
  END_DATE           DATE NOT NULL,
  TIME_SPAN          NUMBER(2) NOT NULL,
  SMONTH_NUM         NUMBER(6) NOT NULL,
  SMONTH_SEQ         NUMBER(4) NOT NULL
);
-- CREATE/RECREATE INDEXES 
CREATE INDEX XIE1DIM_DATE_SMONTH ON DIM_DATE_SMONTH (SMYEAR_ID);

-- CREATE/RECREATE PRIMARY, UNIQUE AND FOREIGN KEY CONSTRAINTS 
ALTER TABLE DIM_DATE_SMONTH
  ADD CONSTRAINT PKDIM_DATE_SMONTH PRIMARY KEY (SMONTH_ID);
  
ALTER TABLE DIM_DATE_SMONTH
  ADD CONSTRAINT FKDIM_DATE_SMONTH_SY FOREIGN KEY (SMYEAR_ID)
  REFERENCES DIM_DATE_SMYEAR (SMYEAR_ID);



--7th_swyear
CREATE TABLE DIM_DATE_SWYEAR
(
  SWYEAR_ID   NUMBER(4) NOT NULL,
  SWYEAR_DESC VARCHAR2(10) NOT NULL,
  START_DATE  DATE NOT NULL,
  END_DATE    DATE NOT NULL,
  TIME_SPAN   NUMBER(3) NOT NULL,
  SWYEAR_NUM  NUMBER(4) NOT NULL,
  SWYEAR_SEQ  NUMBER(4) NOT NULL
);
-- CREATE/RECREATE PRIMARY, UNIQUE AND FOREIGN KEY CONSTRAINTS 
ALTER TABLE DIM_DATE_SWYEAR
  ADD CONSTRAINT PKDIM_DATE_SWYEAR PRIMARY KEY (SWYEAR_ID);
...
(
  ...
  SWYEAR_ID          NUMBER(6) NOT NULL,
  SWEEK_OF_SWYEAR    NUMBER(2) NOT NULL,
  IS_FIRST_OF_SWYEAR CHAR(1) NOT NULL,
  IS_LAST_OF_SWYEAR  CHAR(1) NOT NULL,
  START_DATE         DATE NOT NULL,
  END_DATE           DATE NOT NULL,
  TIME_SPAN          NUMBER(1) NOT NULL,
  SWEEK_NUM          NUMBER(6) NOT NULL,
  SWEEK_SEQ          NUMBER(6) NOT NULL
);
-- CREATE/RECREATE INDEXES 
CREATE INDEX XIE1DIM_DATE_SWEEK ON DIM_DATE_SWEEK (SWYEAR_ID);
-- CREATE/RECREATE PRIMARY, UNIQUE AND FOREIGN KEY CONSTRAINTS 

ALTER TABLE DIM_DATE_SWEEK
  ADD CONSTRAINT PKDIM_DATE_SWEEK PRIMARY KEY (SWEEK_ID);
  
ALTER TABLE DIM_DATE_SWEEK
  ADD CONSTRAINT FKDIM_DATE_SWEEK_SY FOREIGN KEY (SWYEAR_ID)
  REFERENCES DIM_DATE_SWYEAR (SWYEAR_ID);



--7th_sweek_part
CREATE TABLE DIM_DATE_SWEEK_PART
(
  SWEEK_PART_ID        NUMBER(6) NOT NULL,
  SWEEK_PART_DESC      VARCHAR2(10) NOT NULL,
  SMONTH_ID            NUMBER(6) NOT NULL,
  SWEEK_ID             NUMBER(6) NOT NULL,
  SWEEK_PART_OF_SMONTH NUMBER(2) NOT NULL,
  SWEEK_PART_OF_SWEEK  NUMBER(2) NOT NULL,
  IS_FIRST_OF_SMONTH   CHAR(1) NOT NULL,
  IS_LAST_OF_SMONTH    CHAR(1) NOT NULL,
  IS_FIRST_OF_SWEEK    CHAR(1) NOT NULL,
  IS_LAST_OF_SWEEK     CHAR(1) NOT NULL,
  START_DATE           DATE NOT NULL,
  END_DATE             DATE NOT NULL,
  TIME_SPAN            NUMBER(1) NOT NULL,
  SWEEK_PART_NUM       NUMBER(6) NOT NULL,
  SWEEK_PART_SEQ       NUMBER(6) NOT NULL
);
-- CREATE/RECREATE INDEXES 
CREATE INDEX XIE1DIM_DATE_SWEEK_PART ON DIM_DATE_SWEEK_PART (SMONTH_ID);
CREATE INDEX XIE2DIM_DATE_SWEEK_PART ON DIM_DATE_SWEEK_PART (SWEEK_ID);
-- CREATE/RECREATE PRIMARY, UNIQUE AND FOREIGN KEY CONSTRAINTS 
ALTER TABLE DIM_DATE_SWEEK_PART
  ADD CONSTRAINT PKDIM_DATE_SWEEK_PART PRIMARY KEY (SWEEK_PART_ID);
ALTER TABLE DIM_DATE_SWEEK_PART
  ADD CONSTRAINT FKDIM_DATE_SWEEK_PART_SM FOREIGN KEY (SMONTH_ID)
  REFERENCES DIM_DATE_SMONTH (SMONTH_ID);
ALTER TABLE DIM_DATE_SWEEK_PART
  ADD CONSTRAINT FKDIM_DATE_SWEEK_PART_SW FOREIGN KEY (SWEEK_ID)
...
(
  ...
  IYEAR_SEQ  NUMBER(4) NOT NULL
);
-- CREATE/RECREATE PRIMARY, UNIQUE AND FOREIGN KEY CONSTRAINTS 
ALTER TABLE DIM_DATE_IYEAR
  ADD CONSTRAINT PKDIM_DATE_IYEAR PRIMARY KEY (IYEAR_ID);
...
(
  ...
  IS_FIRST_OF_IYEAR CHAR(1) NOT NULL,
  IS_LAST_OF_IYEAR  CHAR(1) NOT NULL,
  START_DATE        DATE NOT NULL,
  END_DATE          DATE NOT NULL,
  TIME_SPAN         NUMBER(1) NOT NULL,
  IWEEK_NUM         NUMBER(6) NOT NULL,
  IWEEK_SEQ         NUMBER(6) NOT NULL
);
-- CREATE/RECREATE INDEXES 
CREATE INDEX XIE1DIM_DATE_IWEEK_CY ON DIM_DATE_IWEEK (IYEAR_ID);
-- CREATE/RECREATE PRIMARY, UNIQUE AND FOREIGN KEY CONSTRAINTS 
ALTER TABLE DIM_DATE_IWEEK
  ADD CONSTRAINT PKDIM_DATE_IWEEK PRIMARY KEY (IWEEK_ID);
ALTER TABLE DIM_DATE_IWEEK
  ADD CONSTRAINT FKDIM_DATE_IWEEK_IY FOREIGN KEY (IYEAR_ID)
  REFERENCES DIM_DATE_IYEAR (IYEAR_ID);
...
(
  ...
  DAY_OF_CMONTH          NUMBER(2) NOT NULL,
  DAY_OF_CYEAR           NUMBER(3) NOT NULL,
  DAY_OF_IWEEK           NUMBER(1) NOT NULL,
  DAY_OF_IYEAR           NUMBER(3) NOT NULL,
  DAY_OF_SWEEK_PART      NUMBER(1) NOT NULL,
  DAY_OF_SWEEK           NUMBER(1) NOT NULL,
  DAY_OF_SWYEAR          NUMBER(3) NOT NULL,
  DAY_OF_SMONTH          NUMBER(2) NOT NULL,
  DAY_OF_SMYEAR          NUMBER(3) NOT NULL,
  IS_FIRST_OF_CWEEK      CHAR(1) NOT NULL,
  IS_LAST_OF_CWEEK       CHAR(1) NOT NULL,
  IS_FIRST_OF_CMONTH     CHAR(1) NOT NULL,
  IS_LAST_OF_CMONTH      CHAR(1) NOT NULL,
  IS_FIRST_OF_CYEAR      CHAR(1) NOT NULL,
  IS_LAST_OF_CYEAR       CHAR(1) NOT NULL,
  IS_FIRST_OF_IWEEK      CHAR(1) NOT NULL,
  IS_LAST_OF_IWEEK       CHAR(1) NOT NULL,
  IS_FIRST_OF_IYEAR      CHAR(1) NOT NULL,
  IS_LAST_OF_IYEAR       CHAR(1) NOT NULL,
  IS_FIRST_OF_SWEEK_PART CHAR(1) NOT NULL,
  IS_LAST_OF_SWEEK_PART  CHAR(1) NOT NULL,
  IS_FIRST_OF_SWEEK      CHAR(1) NOT NULL,
  IS_LAST_OF_SWEEK       CHAR(1) NOT NULL,
  IS_FIRST_OF_SWYEAR     CHAR(1) NOT NULL,
  IS_LAST_OF_SWYEAR      CHAR(1) NOT NULL,
  ...
  IS_FIRST_OF_SMYEAR     CHAR(1) NOT NULL,
  IS_LAST_OF_SMYEAR      CHAR(1) NOT NULL,
  DAY_SEQ                NUMBER(8) NOT NULL
);
-- CREATE/RECREATE INDEXES 
CREATE INDEX XIE1DIM_DATE_DAY ON DIM_DATE_DAY (CWEEK_ID);
CREATE INDEX XIE2DIM_DATE_DAY ON DIM_DATE_DAY (CMONTH_ID);
CREATE INDEX XIE3DIM_DATE_DAY ON DIM_DATE_DAY (IWEEK_ID);
CREATE INDEX XIE4DIM_DATE_DAY ON DIM_DATE_DAY (SWEEK_PART_ID);
-- CREATE/RECREATE PRIMARY, UNIQUE AND FOREIGN KEY CONSTRAINTS 
ALTER TABLE DIM_DATE_DAY
  ADD CONSTRAINT PKDIM_DATE_DAY PRIMARY KEY (DATE_ID);
ALTER TABLE DIM_DATE_DAY
  ADD CONSTRAINT UN1DIM_DATE_DAY UNIQUE (DAY_DATE);
ALTER TABLE DIM_DATE_DAY
  ADD CONSTRAINT FKDIM_DATE_DAY_CMONTH FOREIGN KEY (CMONTH_ID)
  REFERENCES DIM_DATE_CMONTH (CMONTH_ID);
ALTER TABLE DIM_DATE_DAY
  ADD CONSTRAINT FKDIM_DATE_DAY_CWEEK FOREIGN KEY (CWEEK_ID)
  REFERENCES DIM_DATE_CWEEK (CWEEK_ID);
ALTER TABLE DIM_DATE_DAY
  ADD CONSTRAINT FKDIM_DATE_DAY_IWEEK FOREIGN KEY (IWEEK_ID)
  REFERENCES DIM_DATE_IWEEK (IWEEK_ID);
ALTER TABLE DIM_DATE_DAY
  ADD CONSTRAINT FKDIM_DATE_DAY_SWEEK_PART FOREIGN KEY (SWEEK_PART_ID)
  REFERENCES DIM_DATE_SWEEK_PART (SWEEK_PART_ID);
...
--**************************************************************************************
--**************************************************************************************
CREATE OR REPLACE VIEW V_DIM_TIME_CALENDAR_YMD AS
SELECT D.DATE_ID,
       D.DAY_DATE,
       D.DAY_DESC,
       D.CWEEK_ID,
       ...
       D.IS_FIRST_OF_IYEAR,
       D.IS_LAST_OF_IYEAR,
       D.IS_FIRST_OF_SWEEK_PART,
       D.IS_LAST_OF_SWEEK_PART,
       D.IS_FIRST_OF_SWEEK,
       D.IS_LAST_OF_SWEEK,
       D.IS_FIRST_OF_SWYEAR,
       D.IS_LAST_OF_SWYEAR,
       D.IS_FIRST_OF_SMONTH,
       D.IS_LAST_OF_SMONTH,
       D.IS_FIRST_OF_SMYEAR,
       D.IS_LAST_OF_SMYEAR,
       D.START_DATE,
       D.END_DATE,
       D.TIME_SPAN,
       D.DAY_NUM,
       D.DAY_SEQ,
       CM.CMONTH_ID             CM_CMONTH_ID,
       CM.CMONTH_DESC           CM_CMONTH_DESC,
       CM.CYEAR_ID              CM_CYEAR_ID,
       CM.CMONTH_OF_CYEAR       CM_CMONTH_OF_CYEAR,
       CM.CMONTH_NAME           CM_CMONTH_NAME,
       CM.IS_FIRST_OF_CYEAR     CM_IS_FIRST_OF_CYEAR,
       CM.IS_LAST_OF_CYEAR      CM_IS_LAST_OF_CYEAR,
       CM.START_DATE            CM_START_DATE,
       CM.END_DATE              CM_END_DATE,
       CM.TIME_SPAN             CM_TIME_SPAN,
       CM.CMONTH_NUM            CM_CMONTH_NUM,
       CM.CMONTH_SEQ            CM_CMONTH_SEQ,
       ...
       CY.CYEAR_SEQ             CY_CYEAR_SEQ
  FROM DIM_DATE_DAY D
 INNER JOIN DIM_DATE_CMONTH CM
    ON D.CMONTH_ID = CM.CMONTH_ID
 INNER JOIN DIM_DATE_CYEAR CY
    ON CM.CYEAR_ID = CY.CYEAR_ID;



CREATE OR REPLACE VIEW V_DIM_TIME_CALENDAR_YM AS
SELECT CM.CMONTH_ID         CMONTH_ID,
       CM.CMONTH_DESC       CMONTH_DESC,
       CM.CYEAR_ID          CYEAR_ID,
       CM.CMONTH_OF_CYEAR   CMONTH_OF_CYEAR,
       CM.CMONTH_NAME       CMONTH_NAME,
       CM.IS_FIRST_OF_CYEAR IS_FIRST_OF_CYEAR,
       CM.IS_LAST_OF_CYEAR  IS_LAST_OF_CYEAR,
       CM.START_DATE        START_DATE,
       CM.END_DATE          END_DATE,
       CM.TIME_SPAN         TIME_SPAN,
       CM.CMONTH_NUM        CMONTH_NUM,
       CM.CMONTH_SEQ        CMONTH_SEQ,
       CY.CYEAR_ID   CY_CYEAR_ID,
       CY.CYEAR_DESC CY_CYEAR_DESC,
       CY.START_DATE CY_START_DATE,
       CY.END_DATE   CY_END_DATE,
       ...
       CY.CYEAR_NUM  CY_CYEAR_NUM,
       CY.CYEAR_SEQ  CY_CYEAR_SEQ
  FROM DIM_DATE_CMONTH CM
 INNER JOIN DIM_DATE_CYEAR CY
    ON CM.CYEAR_ID = CY.CYEAR_ID;

    
    
CREATE OR REPLACE VIEW V_DIM_TIME_CALENDAR_YWD AS
SELECT D.DATE_ID,
       D.DAY_DATE,
       D.DAY_DESC,
       D.CWEEK_ID,
       ...
       CW.IS_FIRST_OF_CYEAR     CW_IS_FIRST_OF_CYEAR,
       CW.IS_LAST_OF_CYEAR      CW_IS_LAST_OF_CYEAR,
       CW.START_DATE            CW_START_DATE,
       CW.END_DATE              CW_END_DATE,
       CW.TIME_SPAN             CW_TIME_SPAN,
       CW.CWEEK_NUM             CW_CWEEK_NUM,
       CW.CWEEK_SEQ             CW_CWEEK_SEQ,
       CY.CYEAR_ID              CY_CYEAR_ID,
       CY.CYEAR_DESC            CY_CYEAR_DESC,
       CY.START_DATE            CY_START_DATE,
       CY.END_DATE              CY_END_DATE,
...
CREATE OR REPLACE VIEW V_DIM_TIME_ISO_YWD AS
SELECT D.DATE_ID,
       D.DAY_DATE,
       D.DAY_DESC,
       D.CWEEK_ID,
       ...
       IW.IS_FIRST_OF_IYEAR     IW_IS_FIRST_OF_IYEAR,
       IW.IS_LAST_OF_IYEAR      IW_IS_LAST_OF_IYEAR,
       IW.START_DATE            IW_START_DATE,
       IW.END_DATE              IW_END_DATE,
       IW.TIME_SPAN             IW_TIME_SPAN,
       IW.IWEEK_NUM             IW_IWEEK_NUM,
       IW.IWEEK_SEQ             IW_IWEEK_SEQ,
...
CREATE OR REPLACE VIEW V_DIM_TIME_ISO_YW AS
SELECT IW.IWEEK_ID,
       IW.IWEEK_DESC,
       IW.IYEAR_ID,
       IW.IWEEK_OF_IYEAR,
       IW.IS_FIRST_OF_IYEAR,
       IW.IS_LAST_OF_IYEAR,
       IW.START_DATE,
       IW.END_DATE,
       IW.TIME_SPAN,
...
CREATE OR REPLACE VIEW V_DIM_TIME_7TH_ALL AS
SELECT D.DATE_ID,
       D.DAY_DATE,
       D.DAY_DESC,
       D.CWEEK_ID,
       ...
       D.DAY_NUM,
       D.DAY_SEQ,
       SWP.SWEEK_PART_ID        SWP_SWEEK_PART_ID,
       SWP.SWEEK_PART_DESC      SWP_SWEEK_PART_DESC,
       SWP.SMONTH_ID            SWP_SMONTH_ID,
       SWP.SWEEK_ID             SWP_SWEEK_ID,
       SWP.SWEEK_PART_OF_SMONTH SWP_SWEEK_PART_OF_SMONTH,
       SWP.SWEEK_PART_OF_SWEEK  SWP_SWEEK_PART_OF_SWEEK,
       SWP.IS_FIRST_OF_SMONTH   SWP_IS_FIRST_OF_SMONTH,
       SWP.IS_LAST_OF_SMONTH    SWP_IS_LAST_OF_SMONTH,
       SWP.IS_FIRST_OF_SWEEK    SWP_IS_FIRST_OF_SWEEK,
       SWP.IS_LAST_OF_SWEEK     SWP_IS_LAST_OF_SWEEK,
       SWP.START_DATE           SWP_START_DATE,
       SWP.END_DATE             SWP_END_DATE,
       SWP.TIME_SPAN            SWP_TIME_SPAN,
       SWP.SWEEK_PART_NUM       SWP_SWEEK_PART_NUM,
       SWP.SWEEK_PART_SEQ       SWP_SWEEK_PART_SEQ,
       SW.SWEEK_ID              SW_SWEEK_ID,
       SW.SWEEK_DESC            SW_SWEEK_DESC,
       SW.SWYEAR_ID             SW_SWYEAR_ID,
       SW.SWEEK_OF_SWYEAR       SW_SWEEK_OF_SWYEAR,
       SW.IS_FIRST_OF_SWYEAR    SW_IS_FIRST_OF_SWYEAR,
       SW.IS_LAST_OF_SWYEAR     SW_IS_LAST_OF_SWYEAR,
       SW.START_DATE            SW_START_DATE,
       SW.END_DATE              SW_END_DATE,
       SW.TIME_SPAN             SW_TIME_SPAN,
       SW.SWEEK_NUM             SW_SWEEK_NUM,
       SWY.SWYEAR_ID            SWY_SWYEAR_ID,
       SWY.SWYEAR_DESC          SWY_SWYEAR_DESC,
       SWY.START_DATE           SWY_START_DATE,
       SWY.END_DATE             SWY_END_DATE,
       SWY.TIME_SPAN            SWY_TIME_SPAN,
       SWY.SWYEAR_NUM           SWY_SWYEAR_NUM,
       SWY.SWYEAR_SEQ           SWY_SWYEAR_SEQ,
       SM.SMONTH_ID             SM_SMONTH_ID,
       SM.SMONTH_DESC           SM_SMONTH_DESC,
       SM.SMYEAR_ID             SM_SMYEAR_ID,
       SM.SMONTH_OF_SMYEAR      SM_SMONTH_OF_SMYEAR,
       SM.SMONTH_NAME           SM_SMONTH_NAME,
       SM.IS_FIRST_OF_SMYEAR    SM_IS_FIRST_OF_SMYEAR,
       SM.IS_LAST_OF_SMYEAR     SM_IS_LAST_OF_SMYEAR,
       SM.START_DATE            SM_START_DATE,
       SM.END_DATE              SM_END_DATE,
       SM.TIME_SPAN             SM_TIME_SPAN,
       SM.SMONTH_NUM            SM_SMONTH_NUM,
       SM.SMONTH_SEQ            SM_SMONTH_SEQ,
       SMY.SMYEAR_ID            SMY_SMYEAR_ID,
       SMY.SMYEAR_DESC          SMY_SMYEAR_DESC,
       SMY.START_DATE           SMY_START_DATE,
       SMY.END_DATE             SMY_END_DATE,
       SMY.TIME_SPAN            SMY_TIME_SPAN,
       SMY.SMYEAR_NUM           SMY_SMYEAR_NUM,
       SMY.SMYEAR_SEQ           SMY_SMYEAR_SEQ
  FROM DIM_DATE_DAY D
 INNER JOIN DIM_DATE_SWEEK_PART SWP
    ON D.SWEEK_PART_ID = SWP.SWEEK_PART_ID
 INNER JOIN DIM_DATE_SWEEK SW
    ON SWP.SWEEK_ID = SW.SWEEK_ID
 INNER JOIN DIM_DATE_SWYEAR SWY
    ON SW.SWYEAR_ID = SWY.SWYEAR_ID
 INNER JOIN DIM_DATE_SMONTH SM
    ON SWP.SMONTH_ID=SM.SMONTH_ID
 INNER JOIN DIM_DATE_SMYEAR SMY
    ON SM.SMYEAR_ID=SMY.SMYEAR_ID;
...
SELECT
 ...
 SM.SMONTH_OF_SMYEAR,
 SM.SMONTH_NAME,
 SM.IS_FIRST_OF_SMYEAR,
 SM.IS_LAST_OF_SMYEAR,
 SM.START_DATE,
 SM.END_DATE,
 SM.TIME_SPAN,
 SM.SMONTH_NUM,
...
CREATE OR REPLACE VIEW V_DIM_TIME_7TH_YMD AS
SELECT D.DATE_ID,
       D.DAY_DATE,
       D.DAY_DESC,
       D.CWEEK_ID,
...
CREATE OR REPLACE VIEW V_DIM_TIME_7TH_YMWSWP AS
SELECT
       SWP.SWEEK_PART_ID        SWEEK_PART_ID,
       SWP.SWEEK_PART_DESC      SWEEK_PART_DESC,
       SWP.SMONTH_ID            SMONTH_ID,
       SWP.SWEEK_ID             SWEEK_ID,
       SWP.SWEEK_PART_OF_SMONTH SWEEK_PART_OF_SMONTH,
       SWP.SWEEK_PART_OF_SWEEK  SWEEK_PART_OF_SWEEK,
       SWP.IS_FIRST_OF_SMONTH   IS_FIRST_OF_SMONTH,
       SWP.IS_LAST_OF_SMONTH    IS_LAST_OF_SMONTH,
       SWP.IS_FIRST_OF_SWEEK    IS_FIRST_OF_SWEEK,
       SWP.IS_LAST_OF_SWEEK     IS_LAST_OF_SWEEK,
       SWP.START_DATE           START_DATE,
       SWP.END_DATE             END_DATE,
       SWP.TIME_SPAN            TIME_SPAN,
       SWP.SWEEK_PART_NUM       SWEEK_PART_NUM,
       SWP.SWEEK_PART_SEQ       SWEEK_PART_SEQ,
       SW.SWEEK_ID              SW_SWEEK_ID,
       SW.SWEEK_DESC            SW_SWEEK_DESC,
       SW.SWYEAR_ID             SW_SWYEAR_ID,
       SW.SWEEK_OF_SWYEAR       SW_SWEEK_OF_SWYEAR,
...
CREATE OR REPLACE VIEW V_DIM_TIME_7TH_YW AS
SELECT SW.SWEEK_ID,
       SW.SWEEK_DESC,
       SW.SWYEAR_ID,
       SW.SWEEK_OF_SWYEAR,
       SW.IS_FIRST_OF_SWYEAR,
       SW.IS_LAST_OF_SWYEAR,
       SW.START_DATE,
       SW.END_DATE,
       SW.TIME_SPAN,
       SW.SWEEK_NUM,
...
PARTITION BY RANGE(SWEEK_PART_ID)
  INTERVAL(1)
  (PARTITION P0 VALUES LESS THAN (201301))
COMPRESS FOR OLTP
PARALLEL 
...
ALTER TABLE FACT_POS_SALES_ITEM_WEEK ADD CONSTRAINT FKFACT_POS_SALES_ITEM_WEEK_M FOREIGN KEY (SWEEK_PART_ID)
  REFERENCES DIM_DATE_SWEEK_PART (SWEEK_PART_ID);
...
CREATE BITMAP INDEX BX1FACT_POS_SALES_ITEM_WEEK ON FACT_POS_SALES_ITEM_WEEK (SWEEK_PART_ID) LOCAL PARALLEL;
...
ALTER TABLE FACT_POS_INV_ITEM_WEEK ADD CONSTRAINT FKFACT_POS_INV_ITEM_WEEK_M FOREIGN KEY (SWEEK_PART_ID)
  REFERENCES DIM_DATE_SWEEK_PART (SWEEK_PART_ID);
...
CREATE BITMAP INDEX BX1FACT_POS_INV_ITEM_WEEK ON FACT_POS_INV_ITEM_WEEK (SWEEK_PART_ID) LOCAL PARALLEL;
...
ALTER TABLE FACT_POS_SALES_STYLECOLOR_WEEK ADD CONSTRAINT FKFACT_POS_SALES_SC_WEEK_M FOREIGN KEY (SWEEK_PART_ID)
  REFERENCES DIM_DATE_SWEEK_PART (SWEEK_PART_ID);
...
CREATE BITMAP INDEX BX1FACT_POS_SALES_SC_WEEK ON FACT_POS_SALES_STYLECOLOR_WEEK (SWEEK_PART_ID) LOCAL PARALLEL;
...
ALTER TABLE FACT_POS_INV_STYLECOLOR_WEEK ADD CONSTRAINT FKFACT_POS_INV_SC_WEEK_M FOREIGN KEY (SWEEK_PART_ID)
  REFERENCES DIM_DATE_SWEEK_PART (SWEEK_PART_ID);
...
CREATE BITMAP INDEX BX1FACT_POS_INV_SC_WEEK ON FACT_POS_INV_STYLECOLOR_WEEK (SWEEK_PART_ID)LOCAL PARALLEL;
...
--e.  Whether it should involve all the relevant Forecast/POS_Inventory measurements calculated at the time point of Transferring  still need BA¡¯s confirmation.
...
LOC_CRITERIA_GROUP_ID               NUMBER(7)   NOT NULL,
YEARSEASON_CRITERIA_GROUP_ID        NUMBER(7)   NOT NULL,
SETTING_VALUE_BK                    NUMBER(7)   NOT NULL  --BASE_UNITS_BK
...
--DROP TABLE PROMOTION_RAW PURGE;

CREATE TABLE PROMOTION_RAW(
CORPORATE_DIVISION        VARCHAR2(60),
UPLOAD_FORMAT_CRITERIA    VARCHAR2(60),
VENDOR_REF_NUMBER         VARCHAR2(20),
ACTION_FLAG               VARCHAR2(1),
...
LOC_ATTR4                 VARCHAR2(30),
LOC_ATTR5                 VARCHAR2(30),
...
--BASE_UNITS_CRITERIA       VARCHAR2(60),
FILE_ROW_NUM              NUMBER(9) DEFAULT 0 NOT NULL,
UPLOAD_ID                 NUMBER(9) NOT NULL
)  PARTITION BY RANGE(UPLOAD_ID)
  INTERVAL(1)
...
CREATE TABLE DIM_CLUSTER_SEQUENCE(
CLUSTER_SEQUENCE_ID     NUMBER(7)   NOT NULL
CONSTRAINT PKDIM_CLUSTER_SEQUENCE PRIMARY KEY,
SOURCE_BUSKEY           VARCHAR2(10)NOT NULL,--CMM_CLUSTER_SEQUENCE_ITEM.CMM_CLUSTER_SEQUENCE_ITEM_ID
CLUSTER_NAME            VARCHAR2(30)NOT NULL,
SEQUENCE                NUMBER(5)   NOT NULL,
CONSTRAINT UN1DIM_CLUSTER_SEQUENCE UNIQUE(SOURCE_BUSKEY)
);

CREATE SEQUENCE SEQ_CLUSTER_SEQUENCE
MINVALUE 1
START WITH 1
INCREMENT BY 1
CACHE 20;
...
CREATE INDEX XIE4FACT_MIN_MAX_SC_LOC ON FACT_MIN_MAX_SC_LOC (CLUSTER_SEQUENCE_ID);
-- CREATE/RECREATE PRIMARY, UNIQUE AND FOREIGN KEY CONSTRAINTS 
ALTER TABLE FACT_MIN_MAX_SC_LOC
  ADD CONSTRAINT PKFACT_MIN_MAX_SC_LOC PRIMARY KEY (MIN_MAX_ID, STYLE_COLOR_ID, LOC_ATTR_VALUE_ID,CLUSTER_SEQUENCE_ID);
ALTER TABLE FACT_MIN_MAX_SC_LOC
  ADD CONSTRAINT FKFACT_MIN_MAX_SC_LOC_C FOREIGN KEY (CLUSTER_SEQUENCE_ID)
  REFERENCES DIM_CLUSTER_SEQUENCE (CLUSTER_SEQUENCE_ID);
  
ALTER TABLE FACT_MIN_MAX_SC_LOC
  ADD CONSTRAINT FKFACT_MIN_MAX_SC_LOC_L FOREIGN KEY (LOC_ATTR_VALUE_ID)
  REFERENCES DIM_LOC_ATTR_VALUE (LOC_ATTR_VALUE_ID);
ALTER TABLE FACT_MIN_MAX_SC_LOC
  ADD CONSTRAINT FKFACT_MIN_MAX_SC_LOC_M FOREIGN KEY (MIN_MAX_ID)
  REFERENCES DIM_MIN_MAX (MIN_MAX_ID);
ALTER TABLE FACT_MIN_MAX_SC_LOC
  ADD CONSTRAINT FKFACT_MIN_MAX_SC_LOC_S FOREIGN KEY (STYLE_COLOR_ID)
  REFERENCES DIM_STYLE_COLOR (STYLE_COLOR_ID);
...
CREATE INDEX XIE4FACT_MIN_MAX_PROD_LOC ON FACT_MIN_MAX_PROD_LOC (CLUSTER_SEQUENCE_ID);
-- CREATE/RECREATE PRIMARY, UNIQUE AND FOREIGN KEY CONSTRAINTS 
ALTER TABLE FACT_MIN_MAX_PROD_LOC
  ADD CONSTRAINT PKFACT_MIN_MAX_PROD_LOC PRIMARY KEY (MIN_MAX_ID, PROD_ATTR_VALUE_ID, LOC_ATTR_VALUE_ID, CLUSTER_SEQUENCE_ID);
ALTER TABLE FACT_MIN_MAX_PROD_LOC
  ADD CONSTRAINT FKFACT_MIN_MAX_PROD_LOC_C FOREIGN KEY (CLUSTER_SEQUENCE_ID)
  REFERENCES DIM_CLUSTER_SEQUENCE (CLUSTER_SEQUENCE_ID);
ALTER TABLE FACT_MIN_MAX_PROD_LOC
  ADD CONSTRAINT FKFACT_MIN_MAX_PROD_LOC_L FOREIGN KEY (LOC_ATTR_VALUE_ID)
  REFERENCES DIM_LOC_ATTR_VALUE (LOC_ATTR_VALUE_ID);
ALTER TABLE FACT_MIN_MAX_PROD_LOC
  ADD CONSTRAINT FKFACT_MIN_MAX_PROD_LOC_M FOREIGN KEY (MIN_MAX_ID)
  REFERENCES DIM_MIN_MAX (MIN_MAX_ID);
ALTER TABLE FACT_MIN_MAX_PROD_LOC
  ADD CONSTRAINT FKFACT_MIN_MAX_PROD_LOC_S FOREIGN KEY (PROD_ATTR_VALUE_ID)
  REFERENCES DIM_PROD_ATTR_VALUE (PROD_ATTR_VALUE_ID);



--FACT_PROD_PREPACK
CREATE TABLE FACT_PROD_PREPACK(
GP_SIZE_ID                           NUMBER(7)      NOT NULL,
YEAR_SEASON_ID                       NUMBER(7)      NOT NULL,
PROD_CRITERIA_GROUP_ID               NUMBER(7)      NOT NULL,
PROD_ATTR_VALUE_ID                   NUMBER(7)      NOT NULL,
PREPACK_CODE                         VARCHAR2(60)   NOT NULL,
PREPACK_TYPE                         VARCHAR2(10)   NOT NULL,
PREPACK_QTY                          NUMBER(7)      NOT NULL,
CONSTRAINT PKFACT_PROD_PREPACK PRIMARY KEY(GP_SIZE_ID,YEAR_SEASON_ID,PROD_CRITERIA_GROUP_ID,PROD_ATTR_VALUE_ID)
);


ALTER TABLE FACT_PROD_PREPACK ADD CONSTRAINT FKFACT_PROD_PREPACK_GS 
FOREIGN KEY(GP_SIZE_ID) REFERENCES DIM_GP_SIZE(GP_SIZE_ID);

ALTER TABLE FACT_PROD_PREPACK ADD CONSTRAINT FKFACT_PROD_PREPACK_PG
FOREIGN KEY(PROD_CRITERIA_GROUP_ID) REFERENCES DIM_CRITERIA_GROUP(CRITERIA_GROUP_ID);

ALTER TABLE FACT_PROD_PREPACK ADD CONSTRAINT FKFACT_PROD_PREPACK_PA
FOREIGN KEY(PROD_ATTR_VALUE_ID) REFERENCES DIM_PROD_ATTR_VALUE(PROD_ATTR_VALUE_ID);

ALTER TABLE FACT_PROD_PREPACK ADD CONSTRAINT FKFACT_PROD_PREPACK_YS
FOREIGN KEY(YEAR_SEASON_ID) REFERENCES DIM_YEAR_SEASON(YEAR_SEASON_ID);

CREATE INDEX XIE1FACT_PROD_PREPACK ON FACT_PROD_PREPACK(GP_SIZE_ID);
CREATE INDEX XIE2FACT_PROD_PREPACK ON FACT_PROD_PREPACK(PROD_CRITERIA_GROUP_ID);
CREATE INDEX XIE3FACT_PROD_PREPACK ON FACT_PROD_PREPACK(PROD_ATTR_VALUE_ID);
CREATE INDEX XIE4FACT_PROD_PREPACK ON FACT_PROD_PREPACK(YEAR_SEASON_ID);
